...
public class Matrices
{
    public static void main(String args[])
    {
        ...
        switch (respuesta1){
            //enteros
            case 1:
                MatrizInt m1 = new MatrizInt(CapturaEntrada.capturarEntero("Numero renglones M1"), CapturaEntrada.capturarEntero("Numero columnas M1"));
                MatrizInt m2 = new MatrizInt(CapturaEntrada.capturarEntero("Numero renglones M2"), CapturaEntrada.capturarEntero("Numero columnas M2"));
                m1.iniciarMatInt();
